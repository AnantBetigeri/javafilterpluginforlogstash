...
gem "logstash-filter-java_filter_example", "1.0.0", :path => "vendor/local_gems/57c93e49/logstash-filter-java_filter_example-1.0.0"
gem "jruby-openssl", "0.10.4", :path => "vendor/local_gems/2ee5edeb/jruby-openssl-0.10.4-java"
